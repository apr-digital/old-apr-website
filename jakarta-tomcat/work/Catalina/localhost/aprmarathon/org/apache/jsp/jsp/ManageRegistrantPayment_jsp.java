 ...
 * Generated at: 2022-10-29 14:38:24 UTC
...
import app.appui.RegistrantPaymentBean;
...
public final class ManageRegistrantPayment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/jsp/Footer.jsp", Long.valueOf(1666966515000L));
    _jspx_dependants.put("/jsp/js/validation.js", Long.valueOf(1666966515000L));
    _jspx_dependants.put("/jsp/Header.jsp", Long.valueOf(1666966515000L));
    _jspx_dependants.put("/jsp/Navigation.jsp", Long.valueOf(1666966515000L));
    _jspx_dependants.put("/jsp/js/common_utils.js", Long.valueOf(1666966515000L));
    _jspx_dependants.put("/jsp/LeaderBoard.jsp", Long.valueOf(1666966515000L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("app.appui.RegistrantPaymentBean");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      app.appui.RegistrantPaymentBean RegistrantPaymentBean = null;
      synchronized (session) {
        RegistrantPaymentBean = (app.appui.RegistrantPaymentBean) _jspx_page_context.getAttribute("RegistrantPaymentBean", javax.servlet.jsp.PageContext.SESSION_SCOPE);
        if (RegistrantPaymentBean == null){
          RegistrantPaymentBean = new app.appui.RegistrantPaymentBean();
          _jspx_page_context.setAttribute("RegistrantPaymentBean", RegistrantPaymentBean, javax.servlet.jsp.PageContext.SESSION_SCOPE);
        }
      }
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.introspect(_jspx_page_context.findAttribute("RegistrantPaymentBean"), request);
      out.write("\n");
      out.write("<html>\n");
      out.write("<head>\n");
      out.write("  <title>Manage RegistrantPayments</title>\n");
      ...
      out.print( AppConstants.PAYMENT_AMOUNT_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.PAYMENT_AMOUNT_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.PAYMENT_ADDITIONAL_AMOUNT_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.PAYMENT_ADDITIONAL_AMOUNT_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.PAYMENT_DATE_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.PAYMENT_DATE_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.RECEIPT_DATE_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.RECEIPT_DATE_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.PAYMENT_DETAILS_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.PAYMENT_DETAILS_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif ( tmp.length > 200 ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.PAYMENT_DETAILS_LABEL );
      out.write(" length cannot be greater than 200\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.PAYMENT_TOWARDS_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.PAYMENT_TOWARDS_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif ( tmp.length > 100 ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.PAYMENT_TOWARDS_LABEL );
      out.write(" length cannot be greater than 100\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.PAYMENT_REFERENCE_ID_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.PAYMENT_REFERENCE_ID_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif ( tmp.length > 100 ) {\n");
 ...
 RegistrantPaymentBean.getRequestParameters(request); 
      ...
      out.write('\n');
      out.print( core.appui.UtilBean.getHiddenField(Constants.SS_IMPL_NAME_STR, AppConstants.REGISTRANTPAYMENT_BEAN_NAME_STR) );
      out.write('\n');
      out.print( core.appui.UtilBean.getNextJsp(AppConstants.MANAGE_REGISTRANTPAYMENT_JSP_STR) );
      out.write('\n');
      out.print( RegistrantPaymentBean.getRegistrantPaymentInfo() );
      out.write("\n");
      out.write("</form>\n");
      out.write("<table>\n");
      out.write("<tr>\n");
