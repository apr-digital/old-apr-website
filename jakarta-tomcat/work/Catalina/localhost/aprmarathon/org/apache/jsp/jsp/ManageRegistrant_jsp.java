 ...
 * Generated at: 2022-11-16 07:56:41 UTC
...
import app.appui.RegistrantBean;
...
public final class ManageRegistrant_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/jsp/Footer.jsp", Long.valueOf(1667823756000L));
    _jspx_dependants.put("/jsp/js/validation.js", Long.valueOf(1667823756000L));
    _jspx_dependants.put("/jsp/Header.jsp", Long.valueOf(1667823756000L));
    _jspx_dependants.put("/jsp/Navigation.jsp", Long.valueOf(1667823756000L));
    _jspx_dependants.put("/jsp/js/common_utils.js", Long.valueOf(1667823756000L));
    _jspx_dependants.put("/jsp/LeaderBoard.jsp", Long.valueOf(1667823756000L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("app.appui.RegistrantBean");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      app.appui.RegistrantBean RegistrantBean = null;
      synchronized (session) {
        RegistrantBean = (app.appui.RegistrantBean) _jspx_page_context.getAttribute("RegistrantBean", javax.servlet.jsp.PageContext.SESSION_SCOPE);
        if (RegistrantBean == null){
          RegistrantBean = new app.appui.RegistrantBean();
          _jspx_page_context.setAttribute("RegistrantBean", RegistrantBean, javax.servlet.jsp.PageContext.SESSION_SCOPE);
        }
      }
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.introspect(_jspx_page_context.findAttribute("RegistrantBean"), request);
      out.write("\n");
      out.write("<html>\n");
      out.write("<head>\n");
      out.write("  <title>Manage Registrants</title>\n");
      ...
      out.print( AppConstants.REGISTRANT_NAME_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_NAME_LABEL );
      ...
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.REGISTRANT_EMAIL_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_EMAIL_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif ( tmp.length > 75 ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_EMAIL_LABEL );
      out.write(" length cannot be greater than 75\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.REGISTRANT_PHONE_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_PHONE_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif ( tmp.length > 20 ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_PHONE_LABEL );
      out.write(" length cannot be greater than 20\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.REGISTRANT_ADDRESS_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_ADDRESS_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      ...
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.REGISTRANT_CITY_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_CITY_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif ( tmp.length > 50 ) {\n");
      ...
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.REGISTRANT_STATE_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_STATE_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif ( tmp.length > 50 ) {\n");
      ...
      out.write("\t}\n");
      out.write("\tvar tmp = form.");
      out.print( AppConstants.REGISTRANT_PINCODE_STR);
      out.write(".value;\n");
      out.write("\tif ( isEmpty(tmp) ) {\n");
      out.write("\t\talert(\"");
      out.print( AppConstants.REGISTRANT_PINCODE_LABEL );
      out.write(" cannot be empty\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
 ...
 RegistrantBean.getRequestParameters(request); 
      ...
      out.write('\n');
      out.print( core.appui.UtilBean.getHiddenField(Constants.SS_IMPL_NAME_STR, AppConstants.REGISTRANT_BEAN_NAME_STR) );
      out.write('\n');
      out.print( core.appui.UtilBean.getNextJsp(AppConstants.MANAGE_REGISTRANT_JSP_STR) );
      out.write('\n');
      out.print( RegistrantBean.getRegistrantInfo() );
      out.write("\n");
      out.write("</form>\n");
      out.write("<table>\n");
      out.write("<tr>\n");
